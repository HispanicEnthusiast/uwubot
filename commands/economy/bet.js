...
exports.run = async (client, message, args) => {
    ...
    if (amount > balance || !balance || balance === 0) return message.mentionReply("You don't have enough money.");
    
   
    if (amount < 1) return message.mentionReply("You don't give enough money for gambling. The minimum was $200.");
