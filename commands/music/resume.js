...
module.exports = {
  ...
  info: {
    ...
    usage: "",
    aliases: ["unpause", "continue", "continue-song", "continuesong", "resumesong", "resume-song"],
  },
//checked
  run: async function (bot, message, args) {
    ...
    if (serverQueue && !serverQueue.playing) {
      ...
      .setDescription("<a:Checkmark:858154320117235742> | The music has been resumed!")
      .setColor("YELLOW")
  ...
  const channel = await client.guilds.cache.get(message.guild_id).members.cache.get(message.member.user.id).voice.channel;
    ...
    return sendError("<:Oops:858157163876319252> | There is nothing playing in this server or the bot is currently not paused.", message, client);
  },
};