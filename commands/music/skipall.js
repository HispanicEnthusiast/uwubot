...
let sendSuccess= require("../../util/slash/success"),sendError= require("../../util/slash/error")
    ...
    if (!serverQueue) {
      sendError("<:Oops:858157163876319252> | Nothing playing in this server.", message, client);
    }
    ...
    try {
      ...
      sendSuccess("<a:Checkmark:858154320117235742> | Skipped all songs in the queue!", message, client);
message.react("✅")
      return;
    } catch {
...
let sendSuccess= require("../../util/success"),sendError= require("../../util/error")
    ...
    if (!serverQueue) {
      message.mentionReply("<:Oops:858157163876319252> | Nothing playing in this server.");
    }
