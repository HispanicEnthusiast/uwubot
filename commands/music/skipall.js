...
let sendSuccess= require("../../util/slash/success"),sendError= require("../../util/slash/error")
    ...
    if (!serverQueue) {
      sendError("<a:checkmark:854477462829006858> | Nothing playing in this server", message, client);
    }
...
let sendSuccess= require("../../util/success"),sendError= require("../../util/error")
    ...
    if (!serverQueue) {
      message.mentionReply("<a:checkmark:854477462829006858> | Nothing playing in this server");
    }
